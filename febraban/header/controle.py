...
class ArquivoHeaderControle(TXT):
	def __init__(self):
		...
		self.banco		= TagInteiro(self._tipo_registro, u'01.0', u'banco', 	1, 3, descricao=u'G001', comentario=u'Código do banco na compensação')
		self.lote		= TagInteiro(self._tipo_registro, u'02.0', u'lote', 	4, 7, descricao=u'*G002', comentario=u'Lote de serviço', valor=0000)
		self.registro	= TagInteiro(self._tipo_registro, u'03.0', u'registro',	8, 8, descricao=u'*G003', comentario=u'Tipo de serviço', valor=TIPO_REGISTRO.ARQUIVO_HEADER)
