...
class Inscricao(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'Y'):
		...
		self.tipo	= TagInteiro(self._tipo_registro, u'09.3Y', u'tipo',	 20,  20, descricao=u'*G005', comentario=u'Tipo de inscrição', segmento=self._segmento, lote=self._lote, num_seq=self._num_seq)
		self.numero	= TagInteiro(self._tipo_registro, u'10.3Y', u'numero',	 21,  35, descricao=u'*G006', comentario=u'Número de inscrição', segmento=self._segmento, lote=self._lote, num_seq=self._num_seq)
