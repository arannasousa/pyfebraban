...
class Inscricao(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'Q'):
		...
		self.tipo	= TagInteiro(self._tipo_registro,	u'08.3Q', u'tipo',		18,  18, descricao=u'*G005', comentario=u'Tipo de inscrição',	segmento=self._segmento, lote=self._lote, num_seq=num_seq)
		self.numero	= TagInteiro(self._tipo_registro,	u'09.3Q', u'numero',	19,  33, descricao=u'*G006', comentario=u'Número da inscrição',	segmento=self._segmento, lote=self._lote, num_seq=num_seq)
