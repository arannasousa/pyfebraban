...
class Agencia(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'R'):
		...
		self.codigo	= TagInteiro(self._tipo_registro,	u'23.3R', u'codigo',	211,  215, descricao=u'*G008', comentario=u'Código da agência do débito',	segmento=self._segmento, lote=self._lote, num_seq=num_seq)
		self.dv		= TagCaracter(self._tipo_registro,	u'24.3R', u'dv',		216,  216, descricao=u'*G009', comentario=u'Dígito verificador da agência',	segmento=self._segmento, lote=self._lote, num_seq=num_seq)
