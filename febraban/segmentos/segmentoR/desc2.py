...
class Desconto2(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'R'):
		...
		self.codigo		= TagInteiro(self._tipo_registro,	u'08.3R', u'codigo',	 18,  18, descricao=u'*C021', comentario=u'Código do desconto 2', segmento=self._segmento, lote=self._lote, num_seq=num_seq)
		self.data		= TagData(self._tipo_registro,		u'09.3R', u'data',		 19,  26, descricao=u'C022', comentario=u'Data do desconto 2', segmento=self._segmento, lote=self._lote, num_seq=num_seq)
		self.desconto	= TagDecimal(self._tipo_registro,	u'10.3R', u'desconto',	 27,  41, descricao=u'C023', comentario=u'Valor/percentual a ser concedido', casas_decimais=2, segmento=self._segmento, lote=self._lote, num_seq=num_seq)
