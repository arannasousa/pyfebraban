...
class ContaCorrenteMantenedora(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'Y'):
		...
		self.dv			= TagCaracter(self._tipo_registro, u'13.3Y', u'dv',  39, 39, descricao=u'*G012', comentario=u'Dígito verificador da agência/conta', segmento=self._segmento, lote=self._lote, num_seq=self._num_seq)
