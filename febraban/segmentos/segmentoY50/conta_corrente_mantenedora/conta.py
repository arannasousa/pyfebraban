...
class Conta(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'Y'):
		...
		self.numero	= TagInteiro(self._tipo_registro, u'11.3Y', u'numero', 26,  37, descricao=u'*G010', comentario=u'Número da conta corrente', segmento=self._segmento, lote=self._lote, num_seq=self._num_seq)
		self.dv		= TagCaracter(self._tipo_registro, u'12.3Y', u'dv',	   38,  38, descricao=u'*G011', comentario=u'Dígito verificador da conta', segmento=self._segmento, lote=self._lote, num_seq=self._num_seq)
