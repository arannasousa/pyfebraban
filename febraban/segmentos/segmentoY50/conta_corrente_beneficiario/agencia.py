...
class Agencia(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'Y'):
		...
		self.codigo	= TagInteiro(self._tipo_registro, 	u'19.3Y', u'codigo',	 80,  84, descricao=u'*G008', comentario=u'Código da agência para credi. beneficiário', segmento=self._segmento, lote=self._lote, num_seq=self._num_seq)
		self.dv	= TagCaracter(self._tipo_registro, 		u'20.3Y', u'dv',	 	 85,  85, descricao=u'*G009', comentario=u'Dígito verificador da agência', segmento=self._segmento, lote=self._lote, num_seq=self._num_seq)
