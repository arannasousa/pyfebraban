...
class ContaCorrenteBeneficiario(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'Y'):
		super(ContaCorrenteBeneficiario, self).__init__()
		...
		self.dv			= TagCaracter(self._tipo_registro, u'23.3Y', u'dv',  99, 99, descricao=u'*G012', comentario=u'Dígito verificador da agência/conta', segmento=self._segmento, lote=self._lote, num_seq=self._num_seq)
