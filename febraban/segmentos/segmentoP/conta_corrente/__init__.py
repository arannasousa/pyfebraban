...
class ContaCorrente(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'P'):
		...
		self.dv			= TagCaracter(self._tipo_registro,	u'12.3P', u'dv',	37,  37, descricao=u'*G012', comentario=u'Dígito verificador da Ag/Conta', 	segmento=self._segmento, lote=self._lote, num_seq=num_seq)
