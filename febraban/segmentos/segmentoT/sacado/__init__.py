...
class Sacado(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'T'):
		...
		self.nome		= TagCaracter(self._tipo_registro,	u'25.3T', u'nome',	149, 188, descricao=u'G013', comentario=u'Nome do sacador/avalista', segmento=self._segmento, lote=self._lote, num_seq=num_seq)
