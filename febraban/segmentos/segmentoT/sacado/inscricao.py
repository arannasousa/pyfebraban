...
class Inscricao(TXT):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'T'):
		...
		self.tipo	= TagInteiro(self._tipo_registro,	u'23.3T', u'tipo',		133, 133, descricao=u'*G005', comentario=u'Tipo de inscrição',	segmento=self._segmento, lote=self._lote, num_seq=num_seq)
		self.numero	= TagInteiro(self._tipo_registro,	u'24.3T', u'numero',	134, 148, descricao=u'*G006', comentario=u'Número da inscrição',	segmento=self._segmento, lote=self._lote, num_seq=num_seq)
