...
class Controle(TXT):
	def __init__(self, lote=u'0001'):
		...
		self.registro	= TagInteiro(self._tipo_registro, u'03.5', u'registro',	8, 8, descricao=u'*G003', comentario=u'Tipo de serviço', valor=TIPO_REGISTRO.LOTE_TRAILER, lote=self._lote)
