...
class Controle(TXT):
	def __init__(self, lote=u'0001'):
		...
		self.banco		= TagInteiro(self._tipo_registro, u'01.1', u'banco', 	1, 3, descricao=u'G001', comentario=u'Código do banco na compensação', lote=self._lote)
		self.lote		= TagInteiro(self._tipo_registro, u'02.1', u'lote', 	4, 7, descricao=u'*G002', comentario=u'Lote de serviço', valor=self._lote, lote=self._lote)
		self.registro	= TagInteiro(self._tipo_registro, u'03.1', u'registro',	8, 8, descricao=u'*G003', comentario=u'Tipo de serviço', valor=TIPO_REGISTRO.LOTE_HEADER, lote=self._lote)
