...
class TotaisCobrancaSimples(TXT):
	def __init__(self, lote=u'0001'):
		super(TotaisCobrancaSimples, self).__init__()
		...
		self.qtd	= TagInteiro(self._tipo_registro, u'06.5', u'qtd', 		24, 29, descricao=u'*C070', comentario=u'Quantidade de títulos em cobrança', lote=self._lote)
		self.valor	= TagDecimal(self._tipo_registro, u'07.5', u'valor', 	30, 46, casas_decimais=2, descricao=u'*C071', comentario=u'Valor total dos títulos em carteiras', lote=self._lote)
