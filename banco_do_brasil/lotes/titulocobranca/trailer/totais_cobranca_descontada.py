...
from .....febraban.base import (TagDecimal, TagHora, TagInteiro, TXT)
from .....febraban import TIPO_REGISTRO, NIVEIS, gera_text

class TotaisCobrancaDescontada(TXT):
	def __init__(self, lote=u'0001'):
		super(TotaisCobrancaDescontada, self).__init__()
		...
		self.qtd	= TagInteiro(self._tipo_registro, u'12.5', u'qtd', 		93,  98, descricao=u'*C070', comentario=u'Quantidade de títulos em cobrança', lote=self._lote)
		self.valor	= TagDecimal(self._tipo_registro, u'13.5', u'valor', 	99, 115, casas_decimais=2, descricao=u'*C071', comentario=u'Valor total dos títulos em carteiras', lote=self._lote)
