...
class TotaisCobrancaCaucionada(TXT):
	def __init__(self, lote=u'0001'):
		super(TotaisCobrancaCaucionada, self).__init__()
		...
		self.qtd	= TagInteiro(self._tipo_registro, u'10.5', u'qtd', 		70, 75, descricao=u'*C070', comentario=u'Quantidade de títulos em cobrança', lote=self._lote)
		self.valor	= TagDecimal(self._tipo_registro, u'11.5', u'valor', 	76, 92, casas_decimais=2, descricao=u'*C071', comentario=u'Valor total dos títulos em carteiras', lote=self._lote)
