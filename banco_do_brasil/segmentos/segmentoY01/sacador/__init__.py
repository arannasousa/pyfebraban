...
from .....febraban.segmentos.segmentoY01 import sacador

from .inscricao import Inscricao

class Sacador(sacador.Sacador):
	def __init__(self, lote=u'0001', num_seq=u'00001', segmento=u'Y'):
		super(Sacador, self).__init__(lote=lote, num_seq=num_seq, segmento=segmento)
